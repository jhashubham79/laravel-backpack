            ...
            $('#filter_{{ $filter->key }}').each(function () {
            	...
            	$(this).select2({
				    ...
				    ajax: {
                        ...
                        var new_url = updateDatatablesOnFilterChange(extra_param, val_text, true, {{ $filter->options['debounce'] ?? 0 }});
                        ...
                        updateDatatablesOnFilterChange(extra_param, null, true, {{ $filter->options['debounce'] ?? 0 }});
