@if ($crud->hasAccess('bulkDestroy') && $crud->get('list.bulkActions'))
	<a href="javascript:void(0)" onclick="bulkDestroyEntries(this)" bp-button="bulkDestroy" class="btn btn-sm btn-secondary bulk-button trash-button bulk-destroy-button"><i class="la la-fire-alt"></i> <span>{{ trans('backpack/pro::trash.destroy') }}</span></a>
@endif
