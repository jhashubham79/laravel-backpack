...
@php
    ...
    switch($field['relation_type']) {
        ...
        case 'MorphToMany':
            ...
            // the field is being inserted in an inline create modal case $inlineCreate is set.
        ...
        case 'HasOneThrough':
        case 'HasManyThrough':
            abort(500, "The relationship field does not support {$field['relation_type']} at the moment. This is a 'readonly' relationship type. When we do add support for it, it the field only SHOW the related entries, NOT allow you to select/edit them.", ['developer-error-exception']);
        ...
        case 'MorphTo':
            ...
            break;
        case 'MorphedByMany':
            abort(500, "The relationship field does not support {$field['relation_type']} at the moment, nobody asked for it yet. If you do, please let us know here - https://github.com/Laravel-Backpack/CRUD/issues", ['developer-error-exception']);
            // TODO: complex interface that allows you to select entries from multiple models
        default:
            abort(500, "Unknown relationship type used with the 'relationship' field. Please let the Backpack team know of this new Laravel relationship, so they add support for it.", ['developer-error-exception']);
            break;
    }
@endphp
