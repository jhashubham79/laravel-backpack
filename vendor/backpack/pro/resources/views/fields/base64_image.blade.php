...
{{-- If a field type is shown multiple times on a form, the CSS and JS will only be loaded once --}}
    ...
    @push('crud_fields_styles')
        @basset('https://cdn.jsdelivr.net/npm/cropperjs@1.5.13/dist/cropper.min.css')
        @bassetBlock('backpack/pro/fields/base64-image-field.css')
        <style>
            .hide {
                display: none;
            }
    ...
    @push('crud_fields_scripts')
        @basset('https://cdn.jsdelivr.net/npm/cropperjs@1.5.13/dist/cropper.min.js')
        @basset('https://cdn.jsdelivr.net/npm/jquery-cropper@1.0.1/dist/jquery-cropper.min.js')
        @bassetBlock('backpack/pro/fields/base64-image-field.js')
        <script>
